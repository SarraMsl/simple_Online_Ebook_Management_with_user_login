          ...
          <div class="nav-bar">
            ...
            <div class="nav-list">
                <div class="hamburger">
                 ...
                 <ul>
                    <li><a href="index(2).php#hero" data-after="Home">Home</a></li>
                      <li>
                         <a href="index(2).php#collection" data-after="collection">collection </i></a>     
                        </li>
                          
                          
                          <li><a href="index(2).php#contact" data-after="Contact">Contact</a></li>
                 </ul>
              </div>
           </div>  
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="book-content">
                ...
                <a href="fun/download.php?file=<?php echo $row['file']; ?>" class="add-to-cart">Download</a>
